    ...
    <footer className="bg-neutral text-neutral-content px-6 py-12 mt-20">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between gap-12">
        ...
        <div className="flex-1">
          <h2 className="text-2xl font-bold text-primary mb-2">DevConnect</h2>
          ...
          <p className="text-xs opacity-60 pt-6">
            © {new Date().getFullYear()} DevConnect. Built with 💙 for
            developers.
          </p>
        </div>
          ...
          <ul className="space-y-2">
            ...
            <li className="flex items-center gap-2 md:justify-end">
              ...
              <span>
                ...
                <span className="text-blue-400">@devconnect (coming soon)</span>
              </span>
            </li>
          </ul>
